...
public class CustomerMailApplication {
    ...
    public static void main(String[] args) {
        ...
        CustomerMailFactory customerMailFactory = new CustomerMailFactory();
        CustomerMailApplication app = new CustomerMailApplication(customerMailFactory.createCustomer(customerType));
